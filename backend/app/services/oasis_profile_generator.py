...
class OasisProfileGenerator:
    ...
    def _is_individual_entity(self, entity_type: str) -> bool:
        """Check if the entity is an individual type"""
        return entity_type.lower() in self.INDIVIDUAL_ENTITY_TYPES
    
    def _is_group_entity(self, entity_type: str) -> bool:
        """Check if the entity is a group/institutional type"""
    ...
    def _try_fix_json(self, content: str, entity_name: str, entity_type: str, entity_summary: str = "") -> Dict[str, Any]:
        ...
        if json_match:
            ...
            # 3. Fix newline characters inside strings
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media persona generation expert. Generate detailed, realistic profiles for public opinion simulation that faithfully reconstruct real-world conditions. Return valid JSON only. All string values must not contain unescaped newlines. Write all content in English."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for this entity, faithfully reconstructing real-world conditions.
...
2. persona: Detailed persona description (~2000 characters, plain text) including:
   - Basic info (age, profession, education, location — assume US-based unless evidence otherwise)
   ...
   - Stances and opinions (attitude toward topics, what might provoke or move them)
   - Unique traits (catchphrases, special experiences, hobbies)
   - Personal memory (important part of the persona — describe this individual's connection to the event and their existing actions/reactions)
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account profile for this institution/group entity, faithfully reconstructing real-world conditions.
...
2. persona: Detailed account profile (~2000 characters, plain text) including:
   - Institution basics (official name, nature, founding background, primary functions)
   ...
   - Institutional memory (describe this institution's connection to the event and their existing actions/reactions)
3. age: fixed at 30 (virtual age for institutional accounts)
4. gender: fixed at "other" (institutional accounts use "other")
5. mbti: MBTI type describing account style, e.g. ISTJ for formal/conservative
6. country: country (e.g. "United States")
...
- persona must be one continuous text description, no newline characters
- Write everything in English
- age must be integer 30, gender must be string "other"
- Institutional accounts should communicate in a manner befitting their identity"""
    ...
    def generate_profiles_from_entities(
        ...
        Args:
            ...
            graph_id: Graph ID for Zep retrieval for richer context
    ...
    def _save_twitter_csv(self, profiles: List[OasisAgentProfile], file_path: str):
        ...
        - description: External display, visible to other users as a bio
        """
        import csv
