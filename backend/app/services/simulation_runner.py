...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # Set working directory to the simulation directory (databases etc. will be generated here)
    ...
    def _check_all_platforms_completed(cls, state: SimulationRunState) -> bool:
        ...
        Determines which platforms are enabled by checking whether their actions.jsonl files exist
        ...
        with open(file_path, 'r', encoding='utf-8') as f:
            for line in f:
                ...
                try:
                    ...
                    # Get platform: prefer the record's platform, otherwise use default
    ...
    def register_cleanup(cls):
        ...
        # If not in debug mode, this env variable doesn't exist, and registration is also needed
    ...
    def interview_agent(
        ...
        Args:
            ...
            platform: Specify platform (optional)
                ...
                - None: In dual-platform simulation, interview both platforms and return consolidated results
    ...
    def close_simulation_env(
        ...
        """
        Close simulation environment (not the same as stopping the simulation process)
