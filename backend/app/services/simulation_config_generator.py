...
class EventConfig:
    """Event configuration"""
    # Initial events (trigger events when simulation starts)
...
class SimulationConfigGenerator:
    ...
    def _build_context(
        ...
        remaining_length = self.MAX_CONTEXT_LENGTH - current_length - 500  # Leave 500 chars buffer
...
{{
    "agent_configs": [
        ...
        for i, entity in enumerate(entities):
            ...
            # If LLM didn't generate, fall back to rule-based generation
            if not cfg:
