...
2. PanoramaSearch (Broad Search) - Get full overview, including expired content
...
class EdgeInfo:
    ...
    def is_invalid(self) -> bool:
        """Whether the edge is invalidated"""
...
class InterviewResult:
    ...
    def to_text(self) -> str:
        """Convert to detailed text format for LLM comprehension and report quoting"""
        text_parts = [
...
class ZepToolsService:
    ...
    2. panorama_search - Broad search (get full overview, including expired content)
...
Return the sub-question list in JSON format."""
    ...
    def panorama_search(
        ...
        Get full overview, including all related content and historical/expired information:
        ...
        This tool is suitable for scenarios requiring understanding of the full picture and tracking evolution.
    ...
    def interview_agents(
        ...
        # Step 4: Call the real interview API (no platform specified, default dual-platform)
        try:
            interviews_request = []
...
1. Extract key perspectives from all parties
