    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          ...
          <div class="step-status">
            ...
            <span v-else-if="currentPhase === 0" class="badge processing">In Progress</span>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, auto-chunks documents and calls Zep to build a knowledge graph, extracting entities and relationships to form temporal memory and community summaries
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph build is complete. Proceed to the next step for environment setup.</p>
          <button 
            class="action-btn" 
